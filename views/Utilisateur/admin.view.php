                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                            <a class="nav-link" href="<?= URL ?>Services/ajouterService">Ajout Service</a>
                            <a class="nav-link" href="<?= URL ?>Services/page_modifier_supprimer_service">Supprimer Service</a>
                        </nav>
                    </div>
                    ...
                    <a class="nav-link" href="<?= URL ?>Horaires/modifierHoraires">
                        <div class="sb-nav-link-icon"><i class="fas fa-clock"></i></div>
                        Horaires
                    </a>
                    <a class="nav-link" href="<?= URL ?>administrateur/generer_compte_employe">
