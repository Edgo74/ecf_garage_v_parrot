...
class VoitureController extends MainController{
    ...
    public function ajouterVoitureValidation(){
        ...
        if(!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
            ...
            $this->voitureManager->AjoutVoitureBD($titre , $year , $carburant, 
            $kilometre , $price , $nomImageAjoute);
    ...
    public function modifierVoitureValidation(){
        ...
        $this->voitureManager->modificationVoitureBD($identifiant,$titre ,$year,
        $carburant,$kilometre,$price,$nomImageToAdd );
